...
import com.example.weatherapp.adapter.ForcastAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    var forcasts:List<Forecast>?=null
    lateinit var forcastAdapter: ForcastAdapter
...
//        binding.txtView.visibility = View.GONE
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                forcasts = response.forecasts

                forcastAdapter = ForcastAdapter(forcasts!!)
                ...
                withContext(Dispatchers.Main) {
                    Glide.with(this@MainActivity)
                        ...
                        binding.recyclerView.adapter = forcastAdapter
